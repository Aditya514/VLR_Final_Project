...
def train_nn(wandb_metrics,net, optimizer, loss_fn, train_dl, epochs: Epochs, attack=None, device=None, val_dl=None,
    ...
    while not epochs.stop():
        ...
        if wandb_metrics:
            ...
            wandb.log({"Epoch":epochs.epoch_number,
                       "Accuracy":emp_acc,
                       "Loss":emp_loss,
                       "Validation Accuracy":val_acc,
                       "Adverserial Accuracy":adv_acc})
