...
if __name__ == '__main__':
    ...
    experiment_configs = configs.configs_dict["traffic_signs"]["configs"]
    experiment_hps_sets = configs.configs_dict["traffic_signs"]["hps_dict"]
    ...
    logger.log_print("Dataset name: {}".format("traffic_signs"))
